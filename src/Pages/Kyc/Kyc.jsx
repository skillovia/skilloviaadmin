...
const KycList = () => {
  ...
  const fetchRecords = async () => {
    ...
    try {
      ...
      console.log("Fetched records:", json.data);
                  ...
                  <tr key={r._id} className="even:bg-gray-50 hover:bg-gray-100 transition-colors">
                    ...
                    <td className="px-4 py-3 border-b">
                      <button
                        ...
                        onClick={() => approveKyc(r._id, r.userId)}
                        disabled={r.approval_status === "approved" || approvingId === r._id}
                      >
                        {approvingId === r._id ? (
                  ...
                  <tr>
                    <td colSpan={8} className="text-center py-8 text-gray-500">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-sm">
                          Records will appear here when users submit KYC documents
                        </p>
                      </div>
                    </td>
                  </tr>
